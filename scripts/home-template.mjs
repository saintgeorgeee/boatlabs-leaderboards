...
<body>
  <main class="shell">
    ...
    <section class="choices">
      ...
      <a class="choice performance" href="./tt/"><span class="tag">TT POINTS LEADERBOARD</span><h1>Current leaders</h1><div class="preview">${performance.map((player, index) => previewRow(player, index, "pts")).join("")}</div><span class="arrow">View full leaderboard →</span></a>
    </section>
    <a class="changes-link" href="./changes/"><div><b>DAILY WR CHANGES</b><span>See WRs gained, lost and improved since tracking began.</span></div><strong>OPEN HISTORY →</strong></a>
    <div class="future"><div><b>PERFORMANCE POINTS LEADERBOARD · WORK IN PROGRESS</b><span>A future competitive ranking, separate from these straightforward TT points.</span></div><strong>COMING LATER</strong></div>
